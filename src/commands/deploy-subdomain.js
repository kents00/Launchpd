...
import { checkSubdomainAvailable, listSubdomains } from '../utils/api.js'
import {
  getProjectConfig,
  findProjectRoot,
  updateProjectConfig,
...
import { success, info, warning, spinner } from '../utils/logger.js'
 ...
 */
export async function handleSubdomainMismatch ({
  subdomain,
  configSubdomain,
  projectRoot,
  autoYes
