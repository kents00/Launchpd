...
export async function login () {
  ...
  console.log(
    `Don't have one? Run ${chalk.cyan('"launchpd register"')} first.\n`
  )
  ...
  console.log('')
  console.log(
    `  ${chalk.gray('Email:')} ${chalk.cyan(result.user?.email || 'N/A')}`
  )
...
export async function whoami () {
  ...
  if (!creds) {
    ...
    console.log(
      `Run ${chalk.cyan('"launchpd register"')} to create an account\n`
    )
    return
  }
  ...
  console.log(
    `  2FA: ${result.user?.is_2fa_enabled ? chalk.green('Enabled') : chalk.gray('Disabled')}`
  )
  ...
  console.log('Usage:')
  console.log(
    `  Sites: ${result.usage?.siteCount || 0} / ${result.limits?.maxSites}`
  )
  console.log(
  ...
  console.log(
    `  Storage remaining: ${result.usage?.storageRemainingMB || 0}MB`
  )
  console.log('')
...
export async function quota () {
  ...
  if (!creds) {
    ...
    console.log(
      `   ${chalk.green('→')} ${chalk.white('10 versions per site')}`
    )
    console.log('')
  ...
  console.log('')
  console.log(
    `${chalk.gray('Tier:')}         ${chalk.green(result.tier || 'free')}`
  )
  console.log(
