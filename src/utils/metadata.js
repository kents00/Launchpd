 ...
 */
export function recordDeploymentInMetadata (
  subdomain,
  folderPath,
  fileCount,
  totalBytes = 0,
 ...
 */
export function setActiveVersion (subdomain, version) {
 ...
 */
export function deleteSubdomain (_subdomain) {
 ...
 */
export function removeDeploymentRecords (_subdomain) {
  throw new Error(
