...
import { getCredentials, saveCredentials, clearCredentials, isLoggedIn, getApiKey, getClientToken, getApiSecret } from '../src/utils/credentials.js';
...
describe('credentials utils', () => {
    ...
    describe('getApiSecret', () => {
        ...
        it('returns secret from file if env missing', async () => {
            ...
            existsSync.mockReturnValue(true);
            readFile.mockResolvedValue(JSON.stringify({ apiKey: 'key', apiSecret: 'file-secret' }));
