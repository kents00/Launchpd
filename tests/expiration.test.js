...
import { parseTimeString, calculateExpiresAt, formatTimeRemaining, isExpired } from '../src/utils/expiration.js';
...
describe('expiration utils', () => {
    describe('parseTimeString', () => {
        ...
        it('throws if less than 30 minutes', () => {
            expect(() => parseTimeString('29m')).toThrow('Minimum expiration time is 30 minutes');
    ...
    describe('formatTimeRemaining', () => {
        it('formats days and hours', () => {
            ...
            const future = new Date(Date.now() + 2 * 24 * 60 * 60 * 1000 + 60000).toISOString();
